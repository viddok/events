...
class Upcoming_Events extends \WP_Widget {
	...
	public function form( $instance ) {
        ...
        <p>
            ...
            <input id="<?php echo $this->get_field_id( 'event_status' ); ?>" name="<?php echo $this->get_field_name( 'event_status' ); ?>" type="radio" value="open" <?php checked( $event_status, 'open' ); ?> /> <?php _e( 'Открытое', 'lang' ); ?>
            <input id="<?php echo $this->get_field_id( 'event_status' ); ?>" name="<?php echo $this->get_field_name( 'event_status' ); ?>" type="radio" value="closed" <?php checked( $event_status, 'closed' ); ?> /> <?php _e( 'По приглашению', 'lang' ); ?>
        </p>
        <p>
